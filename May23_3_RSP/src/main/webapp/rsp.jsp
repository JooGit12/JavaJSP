...
<body>
	<table>
		<tr><th colspan="3">가위바위보</th></tr>
		<tr><td align="center" class="subTitle" colspan="3">뭐</td></tr>
		<tr>
			<td align="center" class="subTitle">
				<a href="HomeController?hand=1"><img src="img/h1.png"></a>
			</td>
			<td align="center" class="subTitle">
				<a href="HomeController?hand=2"><img src="img/h2.png"></a>
			</td>
			<td align="center" class="subTitle">
				<a href="HomeController?hand=3"><img src="img/h3.png"></a>
			</td>
		</tr>
		<tr><td class="line" colspan="3"></tr>
		...
		<tr><td align="center" class="subTitle" colspan="3">${result }</td></tr>
		<tr>
